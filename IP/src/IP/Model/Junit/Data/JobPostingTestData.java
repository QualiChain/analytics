...
public class JobPostingTestData {
	...
	public JobPostingTestData(){
		...
		JPs.add(new JobPosting("Job2", "Software Engineer", "JobPosting Comment 2", "Job Description 2", "part_time",
				"Sector 1", "Job Position Name 2", "Listing Organization 1", "Hiring Organization 2", "Location 2", "2020-02-01", "2021-02-01",
		...
		JPs.add(new JobPosting("Job3", "Data Scientist", "JobPosting Comment 3", "Job Description 3", "contract",
				...
				"entity_level", null, null, null, null, null, null));
		...
		JPs.add(new JobPosting("Job8", "PHP Senior Developer", "JobPosting Comment 8", "Job Description 8", "contract",
		...
		JPs.add(new JobPosting("Job18763218", "Data scientist", "Job Post for a university in Colorado", "Need someone to do xyz", "contract", "Data Science",
				"Science Team Leader", "Merquer inc", "USCL", "City Z in Colorado", "01-01-20", "31-05-20", "senior_level", null, null, null,null,null,null));
		JPs.add(new JobPosting("Job12987681", "AVG Construction Team Coordinator", "Manage a team of workers building AVG automatons for factory work",
				...
				"Automation","Team Coordinator/Manager", "Merquer inc", "Imgursa", "Guia", "01-02-20", "01-02-21", "senior_level", null, null,null,null,null,null));
		JPs.add(new JobPosting("Job198273817", "Salary manager for Company X", "Company X requires a salary manager urgently",
				...
				"contract", "Management", "Senior Accounting Expert", "Jason co", "Imgursa", "Guia", "01-09-20", "01-03-21", "senior_level", null, null, null,null,null,null));
